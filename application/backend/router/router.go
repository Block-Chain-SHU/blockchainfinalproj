...
func SetupRouter() *gin.Engine {
	...
	// 获取单条追踪信息
	r.POST("/getTraceInfo", con.GetTraceInfo)
	// 获取用户追踪列表
	r.POST("/getTraceList", middleware.JWTAuthMiddleware(), con.GetTraceList)
	// 获取全部追踪信息
	r.POST("/getAllTraceInfo", middleware.JWTAuthMiddleware(), con.GetAllTraceInfo)
	// 获取追踪历史
	r.POST("/getTraceHistory", middleware.JWTAuthMiddleware(), con.GetTraceHistory)
